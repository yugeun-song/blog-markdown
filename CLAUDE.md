...
- Diagrams (Mermaid): ` ```mermaid ` fence. Renders client-side; theme follows the active site theme. Keep edge labels short — long labels collide with nodes in the auto-layout. Available node classes: `:::accent`, `:::info`, `:::warn`, `:::danger`, `:::muted`.
